...
Evergreen.prototype.getQuestion = function () {
  ...
  // find term with user.strength 0
...
Evergreen.prototype.updateProgress = function () {
  var html = "Question #" + ev.questionNum;
  $('.progress').html(html);
...
Evergreen.prototype.getUserAnswer = function () {
  ...
  if (ev.knowledgeTerm.strength === 0) {
    console.log(ev.knowledgeTerm.strength)
    $('#new-term').removeClass('d-none');

    $('#just-learned-btn').click(function(){
      console.log('just learned button')
  ...
  //   $('#still-learning-btn').click(function(){
  //     ev.knowledgeTerm.strength += 1;
  //     $('#old-term').addClass('d-none');
  //     flashcards();
  //   });
    
  //   $('#know-well-btn').click(function(){
  //     ev.knowledgeTerm.strength -= 1;
  //     $('#old-term').addClass('d-none');
  //     flashcards();
  //   }); 
...
function showResults () {
  $('#flash-cards').html('You learned 10 new terms.')
}
